...
public class CarrinhoResource {
	...
	@Path("{id}/produtos/{idProduto}")
	@PUT
	public Response alteraProduto(Produto produto, @PathParam("id") long id, @PathParam("idProduto") long idProduto) {
		Carrinho carrinho = new CarrinhoDAO().busca(id);		
	...
	@PUT
	public Response alteraQuantidadeProduto(Produto produto, @PathParam("id") long id, @PathParam("idProduto") long idProduto) {
		Carrinho carrinho = new CarrinhoDAO().busca(id);		
